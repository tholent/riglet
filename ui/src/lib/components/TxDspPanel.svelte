<script lang="ts">
	...
	// Count of active stages for the badge
...
<div class="tx-dsp-wrap" bind:this={panelEl} onkeydown={closeOnEscape}>
	<button
	...
	{#if open}
		<div class="tx-dsp-panel" role="dialog" aria-label="TX DSP controls">
